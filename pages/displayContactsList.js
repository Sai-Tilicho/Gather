...
const DisplayContactsList = () => {
  ...
  const filteredContacts = searchQuery?.length === 0 ? contactsData :
              ...
              <div className="top_header">
                ...
                {isAnyContactSelected ? (
                  ...
                  <div
                    ...
                    className="next"
                  >
                    <Tooltip title='Add contact' color="#00000030">
                    ...
                    {sortedContacts?.length > 0 ? (
                      sortedContacts?.map((contactData, index) => (
                        <div
                          ...
                          onClick={
                            () =>
                              handleCheckboxChange(contactData.id, true)
                          }
                          id={`${index}`}
                        >
                          ...
                          <label className="custom-checkbox" htmlFor={`checkbox-${contactData.id}`}>
                            <Input
                              type="checkbox"
